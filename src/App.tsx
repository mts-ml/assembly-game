...
function App() {
   ...
   const wrongGuessCount: number = guessedLetters.filter(letter => !word.includes(letter)).length
   ...
   function addGuessedLetter(letter: string): void {
      setGuessedLetters((previousLetters: string[]) => (
         ...
         alphabet.split('').map(letter => {
            ...
            return (
               <button
                  ...
                  aria-disabled={guessedLetters.includes(letter) ? 'true' : 'false'}
               > {letter}
               </button >
            )
         })
